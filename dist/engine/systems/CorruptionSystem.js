...
export function buildCorruptionState(memoriesStolen) {
...
export function updateCorruptionTimers(state, dt) {
...
export function applyMemorySteal(_state, memoriesStolen) {
