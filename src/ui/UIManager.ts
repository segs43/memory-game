...
export class UIManager {
  ...
  private endingScreen!: HTMLElement;
  private mobileControls!: HTMLElement;
  private memoryCounter!: HTMLElement;
  private corruptionLabel!: HTMLElement;
  private joystickVisual!: HTMLElement;
  ...
  private showEnding(type: EndingType, count: number, time: number): void {
  ...
  private updateCorruptionLabel(tier: CorruptionTier): void {
