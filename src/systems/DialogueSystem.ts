...
import type { NpcEntity } from '@core/types.js';
...
export class DialogueSystem {
   ...
   */
  applyCorruption(text: string, memoriesStolen: number): string {
    if (memoriesStolen < 2) return text;
