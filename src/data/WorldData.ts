...
import type { WallRect, Vec2 } from '@core/types.js';
...
export interface NpcSeedData {
  ...
  uniqueColor: number;      // hex tint color for this NPC's glow
  patrolPath: Vec2[];       // empty = wander AI
  speed: number;
  fleeRadius: number;
}
...
export const MAP_WALLS: WallRect[] = [
  // Outer boundary
  { x: 0,   y: 0,   w: 800, h: 20  },
...
// ── Spawn points ───────────────────────────────────────────────
export const PLAYER_SPAWN: Vec2 = { x: 400, y: 300 };
